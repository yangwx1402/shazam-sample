package com.shazam.sample.dubbo.provider.bootstrap;

import com.shazam.sample.dubbo.interfaces.dto.UserDTO;
import com.shazam.sample.dubbo.provider.localconsumer.UserServiceLocalConsumer;
...
@ComponentScan("com.shazam.sample.dubbo.provider")
@EnableDubbo(scanBasePackages = {"com.shazam.sample.dubbo.provider.service"})
